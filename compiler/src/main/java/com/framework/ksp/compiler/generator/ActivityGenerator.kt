...
import com.framework.ksp.compiler.ext.getAnnotation
import com.framework.ksp.compiler.ext.getAnnotations
import com.framework.ksp.compiler.ext.getKSClassDeclarations
...
class ActivityGenerator(
    ...
    companion object {
        ...
        private val CLASS_NAME_TITLE_PARAM = ClassName("com.framework.mvvm.entity", "TitleParam")
        private val CLASS_NAME_STATUS_BAR_PARAM =
            ClassName("com.framework.mvvm.entity", "StatusBarParam")
        private val CLASS_NAME_ACTIVITY_COMPILER =
            ClassName("com.framework.mvvm.ksp.interfaces", "ActivityCompiler")
        private val CLASS_NAME_BASE_ACTIVITY =
            ClassName("com.framework.mvvm.base.activity", "BaseActivity")
        ...
        private val TYPE_TITLE_BAR_CONTROLLER =
            ClassName("com.framework.mvvm.controller", "TitleBarController")
        private val TYPE_STATUS_BAR_CONTROLLER =
            ClassName("com.framework.mvvm.controller", "StatusBarController")
    ...
    private fun initTitleMenuOnClick(
        ...
        title?.let {
            //第一个文字按钮
            functions.find {
                return@find it.getAnnotations<com.framework.annotation.OnClickFirstText>()
                    .isNotEmpty()
            }?.run {
                val onClickFirstText = getAnnotation<com.framework.annotation.OnClickFirstText>()
            ...
            //第一个图片按钮
            functions.find {
                return@find it.getAnnotations<com.framework.annotation.OnClickFirstDrawable>()
                    .isNotEmpty()
            }?.run {
                val onClickFirstDrawable =
                    getAnnotation<com.framework.annotation.OnClickFirstDrawable>()
            ...
            //第二个文字按钮
            functions.find {
                return@find it.getAnnotations<com.framework.annotation.OnClickSecondText>()
                    .isNotEmpty()
            }?.run {
                val onClickSecondText = getAnnotation<com.framework.annotation.OnClickSecondText>()
            ...
            //第二个图片按钮
            functions.find {
                return@find it.getAnnotations<com.framework.annotation.OnClickSecondDrawable>()
                    .isNotEmpty()
            }?.run {
                val onClickSecondDrawable =
                    getAnnotation<com.framework.annotation.OnClickSecondDrawable>()
