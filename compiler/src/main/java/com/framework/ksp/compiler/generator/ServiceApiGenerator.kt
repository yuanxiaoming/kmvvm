...
class ServiceApiGenerator(
    ...
    companion object {
        ...
        private val CLASS_NAME_SERVICE_API_COMPILER =
            ClassName("com.framework.mvvm.ksp.interfaces", "ServiceApiCompiler")
        private val CLASS_NAME_MAP = ClassName("kotlin.collections", "HashMap")
        private val CLASS_NAME_SERVICE_PARAM = ClassName("com.framework.mvvm.entity", "ServiceParam")
        ...
        private val CLASS_NAME_SERIALIZATION_RESPONSE_BODY_CONVERTER =
            ClassName("com.framework.annotation.interfaces", "SerializationConverter")
        private val CLASS_NAME_BASE_RESPONSE_BODY_CONVERTER =
            ClassName("com.framework.mvvm.network.converter", "BaseResponseBodyConverter")
        private val CLASS_NAME_GSON_RESPONSE_BODY_CONVERTER =
            ClassName("com.framework.mvvm.network.converter", "SerializationResponseBodyConverter")
