...
class KotlinMvvmGenerator(
    ...
    companion object {
        ...
        private val CLASS_NAME_I_GLOBAL_CONFIG_MODEL =
            ClassName("com.framework.mvvm.interfaces", "IGlobalConfig")
        private val CLASS_NAME_KOTLIN_MVVM_COMPILER =
            ClassName("com.framework.mvvm.ksp.interfaces", "GlobalCompiler")
        private val CLASS_NAME_I_OBSERVER_ERROR =
            ClassName("com.framework.mvvm.interfaces", "IFlowError")
        ...
        private val CLASS_NAME_BASE_FRAGMENT =
            ClassName("com.framework.mvvm.base.fragment", "BaseFragment")
    ...
    override fun process(resolver: Resolver) {
        flowErrorsClassDeclaration =
            resolver.getKSClassDeclarations<com.framework.annotation.FlowError>()
        val list = resolver.getKSClassDeclarations<com.framework.annotation.GlobalConfig>()
        if (list.isNotEmpty()) {
            if (list.size > 1) {
