package com.framework.mvvm.controller
...
import com.framework.mvvm.databinding.LayoutTitleBarBinding
import com.framework.mvvm.config.Config
import com.framework.mvvm.entity.TitleMenuParam
import com.framework.mvvm.entity.TitleParam
import com.framework.mvvm.interfaces.IGlobalConfig
import com.framework.mvvm.ksp.KotlinMvvmCompiler
import com.framework.utils.ext.colorResToInt
...
class TitleBarController(
    ...
    private fun drawTextColor(titleBarBinding: LayoutTitleBarBinding) {
        val textColor = if (title.textColor == Config.NO_ASSIGNMENT) {
